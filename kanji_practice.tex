...
%						\node at (\x*\boxdist+\colsep,\y*\boxdist+\rowsep) {\kanji{\k}};
						\node at (\x*\boxdist+\colsep,\y*\boxdist+\rowsep) {\includesvg[width=\boxsizek,height=\boxsizek,inkscapearea=page]{svg/\glyphname_t\opacity.svg}};
					}
				}
				...
				\foreach \y in {8} {
					\foreach \x in {0} {
						...
						\node at (\x*\boxdist+\boxdist-0.25cm,\y*\boxdist-0.25cm) {\includesvg[width=2.25cm,height=2.25cm]{svg/\glyphname_large.svg}};
					}
				}
...
%						\node at (\x*\boxdist+\colsep,\y*\boxdist+\rowsep) {\kanji{\k}};
						\ifnum\strokeidx<\strokecount%
							...
							\node at (\x*\boxdist+\colsep,\y*\boxdist+\rowsep) {\includesvg[width=\boxsizek,height=\boxsizek,inkscapearea=page]{svg/\glyphname_s\si.svg}};
						\else
							\node at (\x*\boxdist+\colsep,\y*\boxdist+\rowsep) {\includesvg[width=\boxsizek,height=\boxsizek,inkscapearea=page]{svg/\glyphname_t0.svg}};
						\fi
					}
				}
			\end{tikzpicture}%
